...
(* OASIS_START *)
(* DO NOT EDIT (digest: a09dd258a42b57f84bb93f43560679c1) *)
(*
...
let setup_t =
  {
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "Ö\152Ü\005¸\143\003\130WÎh\004µSH4";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
